...
<sub>
*The unbracketed number is the site hits for this month. The bracketed number is zero as Staid was just launched this month, correct as of 21/03/2023.
The cumulative hits (as of 10/06/2023) is estimated to be around 9168 hits (PythonAnywhere does not provide cumulative hits data for free-tier accounts).*
<sub/>
## Demo
